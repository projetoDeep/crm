javascript:(function(){
  ...
  function addStickyNote(contact){
    ...
    note.style.cssText="position: fixed;bottom: 10px;right: 10px;background: yellow;padding: 10px;z-index: 9999;max-width: 200px;border: 1px solid #ccc;font-size: 14px;";
  ...
  function renderLabel(contact){
    ...
    labelDisplay.style.cssText="margin-top: 5px;padding: 4px 8px;background: #f0f0f0;border-radius: 4px;font-size: 12px;display: inline-flex;align-items: center;gap: 6px;";
    ...
    closeBtn.innerText="×";
    closeBtn.style.cssText="background: transparent;border: none;cursor: pointer;font-size: 14px;line-height: 1;padding: 0;";
  ...
  function createTag(labelText,onClose){
    ...
    tag.style.cssText="background: #9B111E;color: white;border-radius: 10px;padding: 2px 8px;margin-left: 5px;font-size: 12px;cursor: default;user-select: none;display: inline-flex;align-items: center;";

    const closeBtn=document.createElement("button");
    closeBtn.textContent="×";
    closeBtn.style.cssText="background: transparent;border: none;color: white;font-weight: bold;cursor: pointer;margin-left: 5px;font-size: 14px;line-height: 1;";
    closeBtn.onclick=e=>{
      e.stopPropagation();
      onClose();
    };
  ...
  function addLabelButtonToMessages(){
    ...
    messages.forEach(msg=>{
      ...
      btn.style.cssText="font-size: 10px;padding: 2px 6px;margin-top: 4px;cursor: pointer;border-radius: 3px;border: none;background-color: #25D366;color: white;user-select: none;position: absolute;bottom: 5px;right: 5px;z-index: 10;";
